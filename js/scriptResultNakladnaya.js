...
document.querySelector('.documentName1').innerHTML = "Видаткова накладна № B-00000" + docNumber;
...
const directorPodpis = document.querySelector('.director');

if (seller === "Volin") {
    imgPodpis.innerHTML = imgsVolin[getRandomInt()];
    directorPodpis.innerHTML = "Директор Волін Д. О."
   
} else {
    imgPodpis.innerHTML = imgsMakarenko[getRandomInt()];
    directorPodpis.innerHTML = "Директор Макаренко О. В."
